      ...
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-2xl flex items-center justify-between">
            ...
            <div className={`text-3xl ${getScoreColorClass(result.score)}`}>
              {result.score} <span className="text-base ml-1">điểm</span>
            </div>
          </DialogTitle>
        </DialogHeader>
        ...
        <Tabs defaultValue="overview" className="w-full" onValueChange={setActiveTab}>
          ...
          <TabsContent value="overview" className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <Card>
                ...
                <CardContent>
                  {result.learning_assessment.achieved_objectives.length > 0 ? (
                    <ul className="list-disc pl-5 space-y-1">
                      {result.learning_assessment.achieved_objectives.map((item, index) => (
              ...
              <Card>
                ...
                <CardContent>
                  {result.learning_assessment.missing_points.length > 0 ? (
                    <ul className="list-disc pl-5 space-y-1">
                      {result.learning_assessment.missing_points.map((item, index) => (
                        <li key={index} className="text-sm">{item}</li>
                      ))}
                    </ul>
                  ) : (
              ...
              <Card>
                ...
                <CardContent>
                  {result.learning_assessment.misconceptions.length > 0 ? (
                    <ul className="list-disc pl-5 space-y-1">
                      {result.learning_assessment.misconceptions.map((item, index) => (
                        <li key={index} className="text-sm">{item}</li>
                      ))}
                    </ul>
                  ) : (
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm">{result.learning_assessment.time_efficiency}</p>
                </CardContent>
              </Card>
            </div>
          </TabsContent>
          ...
          <TabsContent value="suggestions" className="space-y-4">
            ...
            <Card>
              ...
              <CardContent>
                <ul className="list-disc pl-5 space-y-1">
                  {result.suggestions.improvement.map((item, index) => (
                    <li key={index} className="text-sm">{item}</li>
                  ))}
                </ul>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent>
                <ul className="list-disc pl-5 space-y-1">
                  {result.suggestions.resources.map((item, index) => (
                    <li key={index} className="text-sm">{item}</li>
                  ))}
                </ul>
              </CardContent>
